...
public class DeviceController {
	...
	/**
	 * Temporary method update presence sensor room
	 */
	@RequestMapping(method = RequestMethod.PUT, value = "{roomId}/devices/pre/{deviceId}")
	public void updateDevice(@RequestBody PresenceSensor device, @PathVariable String roomId,
	...
	/**
	 * Temporary method update TV sensor room
	 */
	@RequestMapping(method = RequestMethod.PUT, value = "{roomId}/devices/tv/{deviceId}")
	public void updateDevice(@RequestBody Television device, @PathVariable String roomId,
			@PathVariable String deviceId) {
		// get the room
		// TODO and update the device
		Device dd = deviceService.getDevice(deviceId);
